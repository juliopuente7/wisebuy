            ...
            {(prevA.length > 0 || prevV.length > 0) && (<>
              ...
              {prevA.length > 0 && (<>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(150px, 1fr))", gap: 8, marginBottom: 18 }}>
                  {prevA.map((u, i) => (<img key={"a" + i} src={u} alt={"Foto del anuncio " + (i + 1)} style={{ width: "100%", height: 120, objectFit: "cover", borderRadius: 10, border: `1px solid ${C.line}` }} />))}
                </div>
              </>)}
              {prevV.length > 0 && (<>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(150px, 1fr))", gap: 8 }}>
                  {prevV.map((u, i) => (<img key={"v" + i} src={u} alt={"Foto de la visita " + (i + 1)} style={{ width: "100%", height: 120, objectFit: "cover", borderRadius: 10, border: `1px solid ${C.line}` }} />))}
                </div>
              </>)}
            </>)}
