...
Todo en español claro para un comprador normal.`;
      ...
      // 3) si vino cortado (faltan cierres), intentar cerrar llaves/corchetes que falten
      if (!parsed) {
        const ini = limpio.indexOf("{");
        if (ini !== -1) {
          let frag = limpio.slice(ini);
          // quitar una posible coma o texto colgando al final
          frag = frag.replace(/,\s*$/, "");
      ...
      if (!parsed) throw new Error("La IA respondió pero no en el formato esperado. Vuelve a intentarlo.");
